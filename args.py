...
def get_parser():
    ...
    parser.add_argument(
        "--feeder",
        default="feeders.feeder_ucla.Feeder",
        help="data loader will be used",
    )
    parser.add_argument(
        "--num_worker", type=int, default=8, help="the number of worker for data loader"
    )
    parser.add_argument(
        "--balanced_sampling",
        type=str2bool,
    ...
    parser.add_argument(
        "--repeat", type=int, default=1, help="the number of repeat for data"
    )
    ...
    parser.add_argument(
        "--num_epoch", type=int, default=110, help="stop training in which epoch"
    )
    parser.add_argument(
